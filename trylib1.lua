...
local C = {
    ...
    white    = Color3.fromRGB(210, 210, 215),
    hi       = Color3.fromRGB(200, 200, 205),
    mid      = Color3.fromRGB(150, 150, 155),
    low      = Color3.fromRGB(90,  90,  95),
    dim      = Color3.fromRGB(50,  50,  54),
    onBg     = Color3.fromRGB(190, 190, 195),
    offBg    = Color3.fromRGB(28,  28,  30),
    knob     = Color3.fromRGB(12,  12,  12),
    toastBg  = Color3.fromRGB(14,  14,  14),
    success  = Color3.fromRGB(180, 200, 180),
    warn     = Color3.fromRGB(200, 190, 150),
    err      = Color3.fromRGB(200, 150, 150),
    info     = Color3.fromRGB(170, 170, 175),
}
