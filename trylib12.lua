...
local C = {
    ...
    white    = Color3.fromRGB(192, 192, 192),
    hi       = Color3.fromRGB(192, 192, 192),
    mid      = Color3.fromRGB(140, 140, 140),
    low      = Color3.fromRGB(90,  90,  90),
    dim      = Color3.fromRGB(45,  45,  45),
    onBg     = Color3.fromRGB(192, 192, 192),
    offBg    = Color3.fromRGB(20,  20,  20),
    knob     = Color3.fromRGB(0,   0,   0),
    toastBg  = Color3.fromRGB(8,   8,   8),
    success  = Color3.fromRGB(192, 192, 192),
    warn     = Color3.fromRGB(192, 192, 192),
    err      = Color3.fromRGB(192, 192, 192),
